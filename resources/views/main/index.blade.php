...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('shablon/template/vendors/typicons.font/font/typicons.css')}}">
    <link rel="stylesheet" href="{{ asset('shablon/template/vendors/css/vendor.bundle.base.css')}}">
    <!-- endinject --> 
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('shablon/template/css/vertical-layout-light/style.css')}}">
    <!-- endinject -->
    <link rel="shortcut icon" href="{{ asset('shablon/template/images/favicon.png')}}" />
  </head>
  <body>
    ...
    <!-- container-scroller -->
    <script src="{{ asset('shablon/template/vendors/js/vendor.bundle.base.js') }} "></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="{{ asset('shablon/template/js/off-canvas.js') }}"></script>
    <script src="{{ asset('shablon/template/js/hoverable-collapse.js') }}"></script>
    <script src="{{ asset('shablon/template/js/template.js') }}"></script>
    <script src="{{ asset('shablon/template/js/settings.js') }}"></script>
    <script src="{{ asset('shablon/template/js/todolist.js') }}"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="{{ asset('shablon/template/vendors/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ asset('shablon/template/vendors/chart.js/Chart.min.js') }}"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="{{ asset('shablon/template/js/dashboard.js') }}"></script>
